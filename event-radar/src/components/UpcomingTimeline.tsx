...
import { Calendar, MapPin, Globe, ExternalLink, Tag } from 'lucide-react';
            ...
            <div className="space-y-2 ml-1.5">
              {dayEvents.map(event => {
                ...
                return (
                  <div
                    key={event.id}
                    className={`border-l-4 ${urgencyBorder(event.date)} bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-r-lg p-4 hover:shadow-md transition-shadow`}
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <a
                        ...
                        className="shrink-0 p-2 rounded-lg bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 transition-colors"
                        title="View & Sign Up"
                      >
